      ...
      <div class="col-12 col-sm-10 col-lg-8">
        ...
        <q-table separator="cell"
          ...
          <template v-slot:top>
            <div v-if="category?.categoryId === 0" class="row full-width">
              ...
              <div class="col-2 row justify-end items-center">
                <q-btn v-if="category.name.length > 0 && category.name.length <= 50"
                       @click="saveCategory"
                       title="Save"
                       flat
                       round
          ...
          <template v-slot:body="props">
            <q-tr v-if="category?.categoryId !== props.row.categoryId"
                  @click="category !== null ? null : startEdit(props.row.categoryId)"
                  :props="props"
